function autoAssignInspectionAndReturnUID(iNumber) {
    // updates the inspection and assigns to a new user
    // requires the inspection id
    // returns the userID of the assigned inspector or false on failure
    ...
    var assignedUserID = inspectorObj.getUserID();
    logDebug("Successfully reassigned inspection " + iObj.getInspectionType() + " to user " + assignedUserID);
