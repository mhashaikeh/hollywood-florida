function autoAssignInspectionByCap(iNumber, itemCapId) {
	// updates the inspection and assigns to a new user
	// requires the inspection id
	iObjResult = aa.inspection.getInspection(itemCapId, iNumber);
	...
	iout = aa.inspection.autoAssignInspector(itemCapId.getID1(), itemCapId.getID2(), itemCapId.getID3(), inspSeq, inspSchedDate)
