function runReportAndSendAsyncWaitTime(reportName, module, itemCap, reportParameters, emailFrom, emailTo, emailTemplate, emailParameters, emailCC) {
    var scriptName = "RUNREPORTANDSENDASYNCWAITTIME";
    var errorEmailTo = "";
