/*------------------------------------------------------------------------------------------------------/
| Program        : POST_PERMIT_RENEWAL_ISSUANCE.js
   ...
   logDebug("parentLic: " + parentCapId);
    ...
    if (b1Exp) {
        ...
        if (b1ExpResult.getSuccess()) {
            ...
            //Copy Permit Document
            copyDocumentCatToCapID(capId, parentCapId, "Permit");
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "POST_PERMIT_RENEWAL_ISSUANCE", err + debug);
}
