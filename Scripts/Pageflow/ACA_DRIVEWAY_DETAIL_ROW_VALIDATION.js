/*------------------------------------------------------------------------------------------------------/
| Program : ACA_DRIVEWAY_DETAIL_ROW_VALIDATION.JS
| Event   : ACA_Before
|
...
loadASITables4ACA();
    ...
    if (((typeof (DRIVEWAYDETAILS) != "object") || (typeof (DRIVEWAYDETAILS) == "object" && DRIVEWAYDETAILS.length == 0))) {
        aa.env.setValue("ERROR:", "Drivway Detail Information Table Not Found");
        logDebug("ERROR: Drivway Detail Information Table Not Found");
        aa.env.setValue("ErrorMessage", "Must Enter Driveway Detail Information");
        cancel = true;
    } else {
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ACA_DRIVEWAY_DETAIL_ROW_VALIDATION", err + debug + err.stack);
}
