/*------------------------------------------------------------------------------------------------------/
| Program : ACA_REQUIRE_LICENSE_PROFESSIONAL.JS
| Event   : ACA_Before
|
    ...
    if (ownerAsBuilder != "Yes"){
        ...
        if (lpList != null){
            ...
            if (!matches(typeOfProperty,"Single Family","Manufactured Home")){
                if (matches(String(lpType),"Certified Residential Contractor","Registered Residential Contractor","Class C Residential Building Contractor")){
                            cancel = true;
                    showMessage = true;
                    comment("The Contractor Type " + lpType + " can not be selected for the Property Type " + typeOfProperty);
                }
            }
        }
    }
