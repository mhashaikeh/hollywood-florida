/*------------------------------------------------------------------------------------------------------/
| Program : ACA_LANDSCAPE_DETAIL_ROW_VALIDATION.JS
| Event   : ACA_Before
|
...
loadASITables4ACA();
    ...
    if ((typeof (LANDSCAPEDETAILS) != "object") || (typeof (LANDSCAPEDETAILS) == "object" && LANDSCAPEDETAILS.length == 0)) {
        aa.env.setValue("ERROR:", "Landscape Detail Information Table Not Found");
        logDebug("ERROR: Landscape Detail Information Table Not Found");
        aa.env.setValue("ErrorMessage", "Must Enter Landscape Detail Information");
        cancel = true;
    } else {
