/*------------------------------------------------------------------------------------------------------/
| Program : ACA_REQUIRED_LIC_AMEND_DOCS.JS
| Event   : ACA_Before
|
...
try {
    ...
    var genLiability = AInfo["Update General Liability Insurance Information"];
    var workComp = AInfo["Update Workers Compensation Information"];
    var stateReg = AInfo["Update State Registration Information"];
    var occLic = AInfo["Update or Add Occupational License Information"];
  

        if (genLiability == "CHECKED") {
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ACA_REQUIRED_LIC_AMEND_DOCS", err + debug + err.stack);
}
