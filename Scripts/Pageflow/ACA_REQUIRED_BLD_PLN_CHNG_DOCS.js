/*------------------------------------------------------------------------------------------------------/
| Program : ACA_REQUIRED_BLD_PLN_CHNG_DOCS.JS
| Event   : ACA_Before
|
...
try {
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ACA_REQUIRED_BLD_PLN_CHNG_DOCS", err + debug + err.stack);
}
