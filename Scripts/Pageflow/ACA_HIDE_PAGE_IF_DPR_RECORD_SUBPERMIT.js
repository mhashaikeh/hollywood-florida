/*------------------------------------------------------------------------------------------------------/
| Program : ACA_HIDE_PAGE_IF_DPR_RECORD_SUBPERMIT.JS
| Event   : ACA_Before
|
...
try {
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ACA_HIDE_PAGE_IF_DPR_RECORD_SUBPERMIT", err + debug + err.stack);
}
