/*------------------------------------------------------------------------------------------------------/
| Program : ACA_REQUIRED_REQUEST_DOCS.JS
| Event   : ACA_Before
|
...
try {
    ...
    if (matches(appTypeString,"PublicWorks/Utilities/Temp Hydrant Meter/NA")) {
      r[documentCount] = "Temporary Hydrant Meter Form";
      documentCount++;
    }

    if (matches(appTypeString,"PublicWorks/Utilities/Water Meter New/NA")) {
      r[documentCount] = "New Service Application";
      documentCount++;
      r[documentCount] = "Proof of Identification";
      documentCount++;
      r[documentCount] = "Warranty Deed/Lease Agreement";
      documentCount++;
    }

    if (matches(appTypeString, "PublicWorks/Utilities/Water Tap/NA")) {
        if (AInfo['Work Performed at Night'] == "Yes"){
            r[documentCount] = "After Hours Inspection Request";
            documentCount++;
        }
    }
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ACA_REQUIRED_REQUEST_DOCS", err + debug + err.stack);
}
