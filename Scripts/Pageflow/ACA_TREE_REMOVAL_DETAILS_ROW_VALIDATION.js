/*------------------------------------------------------------------------------------------------------/
| Program : ACA_TREE_REMOVAL_DETAILS_ROW_VALIDATION.JS
| Event   : ACA_Before
|
...
loadASITables4ACA();
    ...
    if (((typeof (TREEREMOVALDETAILS) != "object") || (typeof (TREEREMOVALDETAILS) == "object" && TREEREMOVALDETAILS.length == 0))) {
        aa.env.setValue("ERROR:", "Tree Removal Details Information Table Not Found");
        logDebug("ERROR: Tree Removal Details Information Table Not Found");
        aa.env.setValue("ErrorMessage", "Must Enter Tree Removal Details Information");
        cancel = true;
    } else {
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ACA_TREE_REMOVAL_DETAILS_ROW_VALIDATION", err + debug + err.stack);
}
