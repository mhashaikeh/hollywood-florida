/*------------------------------------------------------------------------------------------------------/
| Program : RUNREPORTANDSENDASYNCWAITTIME.js
| Event   : RUNREPORTANDSENDASYNCWAITTIME
|
| Usage   : send notification with report and attach.
|
| Client  : N/A
| Action# : N/A
|
...
try{
        ...
        sendNotification(emailFrom, emailTo, emailCC, emailTemplate, emailParameters, rFiles);
