...
try{
    ...
    if (parentCapId != null) {
        ...
        cIds = getChildren("Building/Amendment/Plans Change/NA", parentCapId);
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "CTRCA:Building/Amendment/Plans Change/NA", err + debug + err.stack);
}
