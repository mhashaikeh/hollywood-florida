...
try{
    ...
    if (parentCapId != null) {
        ...
        cIds = getChildren("Fire/Amendment/Plans Change/NA", parentCapId);
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "CTRCA:Fire/Amendment/Plans Change/NA", err + debug + err.stack);
}
