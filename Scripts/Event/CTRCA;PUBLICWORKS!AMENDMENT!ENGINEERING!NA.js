...
try{
    ...
    if (parentCapId != null) {
        ...
        cIds = getChildren("PublicWorks/Amendment/Engineering/NA", parentCapId);
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "CTRCA:PublicWorks/Amendment/Engineering/NA", err + debug + err.stack);
}
