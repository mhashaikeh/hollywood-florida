...
try{
	...
	if(balanceDue<=0 && matches(capStatus,"Ready to Issue","Awaiting Payment")){
		...
		updateAppStatus("Inspection Phase", "Updated By PRA:Building!~!~!~ Script");
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "PRA:PUBLICWORKS!~!~!~", err + debug + err.stack);
}
*/
