...
try{
	...
	if (!publicUser){
	  ...
	  vLicenseID = getParent();
	    ...
	    if (vLicenseID != null) {
	        ...
	        cIds = getChildren("Building/Amendment/Plans Change/NA", vLicenseID);
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "ASA:Licenses/Amendment/NA/NA", err + debug + err.stack);
}
