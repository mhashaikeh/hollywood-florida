...
try{
    ...
    if (parentCapId != null) {
        ...
        cIds = getChildren("PublicWorks/Amendment/Eng Plans Change/NA", parentCapId);
        ...
        var newAltId = parentAltId + "-C" + amendNbr;
    ...
    aa.sendMail("no-reply@accela.com", emailAddress, "", "CTRCA:PublicWorks/Amendment/Eng Plans Change/NA", err + debug + err.stack);
}
